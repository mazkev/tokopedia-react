    ...
    <div className="auth-page-container animate-in">
      <div className="auth-card">
        <div className="auth-header">
          <div className="logo">Toko<span>pedia</span></div>
          <h2>{mode === 'login' ? 'Masuk' : 'Daftar Sekarang'}</h2>
          <p>{mode === 'login' ? 'Belum punya akun Tokopedia?' : 'Sudah punya akun Tokopedia?'} <span className="switch-link" onClick={onSwitch}>{mode === 'login' ? 'Daftar' : 'Masuk'}</span></p>
        </div>
